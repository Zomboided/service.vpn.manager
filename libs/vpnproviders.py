    ...
    for location in locations:
        ...
        try:
            ...
            for line in template:
                ...
                output_line = output_line.replace("#CERT", getBestPathWrapper(vpn_provider + "/" + ca_cert))
                output_line = output_line.replace("#TLSKEY", getBestPathWrapper(vpn_provider + "/" + ta_key))
                output_line = output_line.replace("#CRLVERIFY", getBestPathWrapper(vpn_provider + "/" + crl_pem))
                output_line = output_line.replace("#DH", getBestPathWrapper(vpn_provider + "/" + dh_parm))
